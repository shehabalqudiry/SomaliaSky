    ...
    <div class="col-12 p-3">
        <div class="col-12 col-lg-12 p-0 ">
            ...
            <form id="validate-form" class="row" enctype="multipart/form-data" method="POST"
                ...
                <div class="col-12 col-lg-8 px-5 main-box">
                        ...
                        <div class="col-12 pt-3">
                            <select class="form-control" name="package_id" required>
                                @foreach ($packages as $package)
                                    <option value="{{ $package->id }}" @if ($subscription->package_id == $package->id) selected @endif>
                        ...
                        <div class="col-12 pt-3">
                            <div class="form-switch">
                                <input name="status" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                    checked {{ $subscription->status == 1 ? 'checked' : '' }}
                        ...
                        <div class="col-12 pt-3">
                            <div class="form-switch">
                                <input name="paid" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                    checked {{ $subscription->paid == 1 ? 'checked' : '' }}
                                    style="width: 50px;height:25px" value="1">
                            </div>
                        </div>
                    </div>
