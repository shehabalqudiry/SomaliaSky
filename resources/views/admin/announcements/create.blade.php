...
@section('content')
    <div class="col-12 p-3">
        <div class="col-12 col-lg-9 p-4 mx-auto main-box">
            ...
            <form id="validate-form" method="POST" class="row" action="{{ route('admin.announcements.store') }}"
                        ...
                        <div class="col-12 col-lg-6 my-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" required name="user_id">
                                    ...
                                    <option value="0" @if (old('type') == 0) selected @endif>شخصي</option>
                                    <option value="1" @if (old('type') == 1) selected @endif>تابع للمتجر</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 my-2">
                            ...
                            <div class="col-12 pt-3">
                                <input class="form-control" required name="price" pattern="[0-9]" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row pt-0">
                            ...
                            @foreach (config('laravellocalization.supportedLocales') as $key => $lang)
                                <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}"
                                    ...
                                    <div class="col-12 col-lg-12 my-2">
                                        ...
                                        <div class="col-12 pt-3">
                                            <textarea class="form-control" name="{{ $key }}[description]" style="min-height: 200px">{{ old($key . 'description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="col-12 col-lg-4 my-2">
                            ...
                            <div class="col-12 pt-3">
                                <div class="form-switch">
                                    <input name="is_featured" required min="1" max="10" class="form-controll"
                                        type="number" style="width: 50px;height:25px" value="{{ old('is_featured') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 my-2">
                            ...
                            <div class="col-12 pt-3">
                                <div class="form-switch">
                                    <input name="status" class="form-check-input" type="checkbox"
                                        id="flexSwitchCheckDefault" {{ old('status') == 1 ? 'checked' : '' }}
